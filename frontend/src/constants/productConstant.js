...
export const MECHANIC_PRODUCT_REQUEST = "MECHANIC_PRODUCT_REQUEST";
export const MECHANIC_PRODUCT_SUCCESS = "MECHANIC_PRODUCT_SUCCESS";
export const MECHANIC_PRODUCT_FAIL = "MECHANIC_PRODUCT_FAIL";
