...
import mewLogo2 from "../../../images/Automania-logo.png";
...
export default function Header() {
  ...
  const headersData = [
    ...
    {
      label: (
        <Tooltip title="Mechanics" arrow TransitionComponent={Zoom}>
          <EngineeringIcon style={{ fontSize: "35PX" }} />
        </Tooltip>
      ),
      href: "/mechanics",
    },
    {
      label: (
        <Tooltip title="Blogs" arrow TransitionComponent={Zoom}>
          <ArticleIcon style={{ fontSize: "35PX" }} />
        </Tooltip>
      ),
      href: "/blogs",
    },
